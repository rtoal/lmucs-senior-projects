# The LMU Computer Science Senior Projects

LMU was one of the first universities to require both individual and group-based semester-long projects for the B.S. degree in Computer Science.  Here's a list of these projects.

Help us complete our history project.  If you see your name in this list and we have your project details wrong, please send a pull request. Or send us a pull request with missing or other incorrect details. And do tell your friends who have lost touch to check out the list, too.


<style>
body {font: 11pt Arial;}
table {empty-cells: show;}
th {background-color: #fff5e2; padding: 0.4ex 1ex;}
th[colspan] {font-size: 16pt;}
td {padding: 0.4ex 1ex 0.4ex 0.5ex;}
tr td:nth-child(1) {background-color: #d3d3ff; padding-right: 4ex;}
tr td:nth-child(2) {background-color: #bbffee;}
tr td:nth-child(3) {background-color: #fdf;}
</style>

<table border=1 cellspacing=0>

<tr><th colspan=3>1981-1982
<tr><th><th>&mdash;<th>402 (Phil Dorin)
<tr><td>Christopher Albertson<td>&mdash;<td>Semantic Network

<tr><th colspan=3>1982-1983
<tr><th><th>401 (Phil Dorin)<th>402 (Phil Dorin)
<tr><td>Christopher Barber<td>?<td>Chess
<tr><td>Donna Landy<td>?<td>Chess
<tr><td>Kou-Wei Shen<td>?<td>Chess

<tr><th colspan=3>1983-1984
<tr><th><th>401 (Phil Dorin)<th>402 (Phil Dorin)
<tr><td>James Demetriades<td>Chess on the new IBM PC<td>Experiments with the Apple Lisa
<tr><td>Laurie Parks<td>Chess on the new IBM PC<td>Music Tutorial and Composer
<tr><td>Don Garrett<td>Chess on the new IBM PC<td>Backgammon Player
<tr><td>Ernie Corral<td>Chess on the new IBM PC<td>Commodore 64 to IBM PC communication link
<tr><td>Ted Bettwy<td>Chess on the new IBM PC<td>Commodore 64 to IBM PC communication link
<tr><td>Yee Chew<td>Chess on the new IBM PC<td>96-column display on a PC
<tr><td>James Huang<td>Chess on the new IBM PC<td>Copy Protection Scheme
<tr><td>Greg Pedersen<td>Chess on the new IBM PC<td>Recorder
<tr><td>Inawati Setiadji<td>Chess on the new IBM PC<td>Music Program
<tr><td>Inge Gunanto<td>Chess on the new IBM PC<td>Music Program
<tr><td>Jean Remley<td>Chess on the new IBM PC<td>Crypto Algorithms in Assembly
<tr><td>Richard Keller<td>Chess on the new IBM PC<td>Crypto Algorithms in Assembly
<tr><td>Peter Horie<td>Chess on the new IBM PC<td>Spreadsheet
<tr><td>Rey Rojo<td>Chess on the new IBM PC<td>Spreadsheet
<tr><td>Timothy Schwalm<td>Chess on the new IBM PC<td>&mdash;
<tr><td>Alice Williams<td>Chess on the new IBM PC<td>(<i>fall 1984</i>)
<tr><td>Mike Stemig<td>? (<i>spring 1984</i>)<td>Backgammon Computer Player (<i>fall 1984</i>)

<tr><th colspan=3>1984-1985
